 ...
 * V5: 0.04 → 0.2 (×5) — пассив был неощутим (<0.2 MP/с почти весь ран). Теперь
 * заметный фоновый ручеёк: ~0.7 MP/с в ранней прокачке, ~4 в позднем ране.
 * Добавляется вне softcap, но ограничен log(массы) и скромным per-level — без разгона.
 */
export const HAWKING_BASE_MP_PER_SEC = 0.2;
